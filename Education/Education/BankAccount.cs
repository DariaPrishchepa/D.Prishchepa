...
namespace Education
{
    public abstract class BankAccount
    {
        ...
        public virtual void Refill(double sum)
        {
            ...
            if((_balance+sum) > double.MaxValue) throw new ArgumentOutOfRangeException("sum", "Сумма баланска превышает допустимый предел");
        ...
        public virtual void CloseBankAccount()
        {
            ...
            {
                throw new ArgumentOutOfRangeException("Balance", "Баланс счета должен быть больше нуля");
            }
        }
    }
}
